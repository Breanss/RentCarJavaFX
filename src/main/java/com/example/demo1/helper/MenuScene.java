...
public class MenuScene {
    public void rentScene(User user, AnchorPane anchorPane) throws IOException {
        URL fxmlLocation = getClass().getResource("/com/example/demo1/rent.fxml");
    ...
    public void homeScene(User user, AnchorPane anchorPane) throws IOException {
    ...
    public void carsScene(User user, AnchorPane anchorPane) throws IOException {
        URL fxmlLocation = getClass().getResource("/com/example/demo1/cars.fxml");
        FXMLLoader loader = new FXMLLoader(fxmlLocation);
        Parent root = loader.load();
    ...
    public void usersScene(User user, AnchorPane anchorPane) throws IOException {
        URL fxmlLocation = getClass().getResource("/com/example/demo1/users.fxml");
        FXMLLoader loader = new FXMLLoader(fxmlLocation);
        Parent root = loader.load();
    ...
    public void logoutScene(AnchorPane anchorPane) throws IOException {
